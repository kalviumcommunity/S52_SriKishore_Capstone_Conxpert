...
const MentorCard = ({mentor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
        <div>
            <img src={photo} alt="image" className='h-[25rem] w-full object-cover rounded-[8px]' />
        </div>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[16px]'>
                <span className='flex items-center gap-[16px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>+{totalMentees} Mentees</h3>
