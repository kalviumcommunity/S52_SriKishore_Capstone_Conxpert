        ...
        <>
            <nav className="mt-3 flex items-center justify-evenly">
                <div className="flex items-center   ">
                    ...
                    <h1><span className="text-2xl lg:text-3xl font-bold pt-1 font-display">CON</span><span className="text-3xl font-gray font-display">X</span><span className="text-2xl lg:text-3xl font-bold pt-1 font-display">PERT</span></h1>
                </div>
