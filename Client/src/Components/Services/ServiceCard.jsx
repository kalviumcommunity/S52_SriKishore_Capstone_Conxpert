...
const ServiceCard = ({ item, index }) => {
    ...
    return (
        <div className='lg:py-[30px] px-3 lg:px-5'>
            ...
            <Link
                to='/mentors' className="w-[44px] h-[44px] rounded-full border border-solid border-[rgb(0,0,0)] flex items-center justify-center group hover:bg-primaryColor hover:border-none">
